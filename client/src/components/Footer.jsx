      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 lg:gap-12 mb-20 lg:mb-24">
          ...
          <div className="col-span-2">
            <a className="text-2xl font-black text-[#e1e2eb] flex items-center gap-2 mb-6" href="#">
              <span className="material-symbols-outlined text-[#4cd6fb] text-3xl"><img src={logo} className='h-8 w-8 object-contain'/></span>Server Flow
            </a>
            <p className="text-[#bcc9ce] text-sm mb-8 max-w-xs leading-6 opacity-60">
            ...
            <div className="flex gap-3">
              {/* GitHub */}
              <a className="w-10 h-10 rounded-lg border border-[#3d494d] flex items-center justify-center hover:bg-[#1d2026] hover:text-[#4cd6fb] transition-all text-[#bcc9ce]" href="#">
          ...
          {/* Company Links */}
          <div>
            <h4 className="font-black text-[#e1e2eb] mb-6 uppercase tracking-[0.2em] text-[10px]">Company</h4>
            <ul className="space-y-3 text-[#bcc9ce] text-sm font-semibold">
          ...
          {/* Legal Links */}
          <div>
            <h4 className="font-black text-[#e1e2eb] mb-6 uppercase tracking-[0.2em] text-[10px]">Legal</h4>
            <ul className="space-y-3 text-[#bcc9ce] text-sm font-semibold">
          ...
          {/* Platform Links */}
          <div>
            <h4 className="font-black text-[#e1e2eb] mb-6 uppercase tracking-[0.2em] text-[10px]">Platform</h4>
            <ul className="space-y-3 text-[#bcc9ce] text-sm font-semibold">
          ...
          {/* Support Links */}
          <div>
            <h4 className="font-black text-[#e1e2eb] mb-6 uppercase tracking-[0.2em] text-[10px]">Support</h4>
            <ul className="space-y-3 text-[#bcc9ce] text-sm font-semibold">
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-[#3d494d] flex flex-col md:flex-row justify-between items-center gap-6 text-[#bcc9ce] text-xs font-bold tracking-tight opacity-50">
          <div>© 2024 Server Flow Inc. All rights reserved.</div>
          
          <div className="flex items-center gap-8">
            {/* Dark/Light Mode Toggle */}
            <div className="flex bg-[#1d2026] rounded-lg p-1 border border-[#3d494d]">
              <button className="px-4 py-2 text-[10px] font-black bg-[#4cd6fb] text-[#003642] rounded-md shadow-sm">
                DARK
              </button>
              <button className="px-4 py-2 text-[10px] font-black text-[#bcc9ce] hover:text-[#e1e2eb]">
                LIGHT
              </button>
            </div>
